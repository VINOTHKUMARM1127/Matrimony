  ...
  const menuGroups = [
    {
      ...
      items: [
        { icon: 'edit', tint: colors.primary, label: 'Edit Profile', screen: 'EditProfile' },
        { icon: 'sparkles', tint: colors.gold, label: 'Horoscope Details', screen: 'EditProfile', params: { initialTab: 'horoscope' } },
      ],
    },
    {
      title: 'Account',
      items: [
        { icon: 'crown', tint: colors.gold, label: 'Premium Plans', screen: 'Premium' },
        { icon: 'bell', tint: colors.primary, label: 'Notifications', screen: 'Notifications' },
        { icon: 'privacy', tint: colors.textSecondary, label: 'Privacy & Security', screen: 'Privacy' },
      ],
    },
  ];
    ...
    <SafeAreaView style={styles.safeContainer} edges={['top', 'left', 'right']}>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          >
            <Icon name="chevronLeft" size={28} color={colors.textPrimary} strokeWidth={2.5} />
          </TouchableOpacity>
          ...
          <View style={styles.heroContent}>
            <View style={styles.avatarContainer}>
              <Avatar
                ...
                fallbackText={!primaryPhoto ? "No Photo" : ""}
              />
              <TouchableOpacity
            ...
            <View style={styles.heroBadges}>
              ...
              {profile?.is_verified && (
                <View style={styles.verBadge}>
                  <Icon name="verified" size={14} color={colors.success} style={{ marginRight: 4 }} />
            ...
            <View style={styles.menuCard}>
              {group.items.map((item, ii) => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <View style={[styles.menuIconContainer, { backgroundColor: (item.tint || colors.textSecondary) + '15' }]}>
                    <Icon name={item.icon} size={18} color={item.tint || colors.textSecondary} />
                  </View>
